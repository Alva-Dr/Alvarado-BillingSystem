...
builder.Configuration.AddEnvironmentVariables(); // Ensure configuration picks up the newly loaded environment variables
...
{
    app.UseDeveloperExceptionPage(); // Temporarily force this to see the error
